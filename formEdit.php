    ...
    <div class="row">
            ...
            <div class="form-group">
                    ...
                    <select name="prodi" class="form-control">
                        ...
                        <option value="D3 Akutansi" <?php echo $prodi=='D3 Akutansi' ? 'selected':'';?>>D3 Akutansi</option>
                        <option value="D3 Teknik Komputer" <?php echo $prodi=='D3 Teknik Komputer' ? 'selected':'';?>>D3 Teknik Komputer</option>
                        <option value="D3 Teknik Mesin" <?php echo $prodi=='D3 Teknik Mesin' ? 'selected':'';?>>D3 Teknik Mesin</option>
                        <option value="D3 Teknik Elektro" <?php echo $prodi=='D3 Teknik Elektro' ? 'selected':'';?>>D3 Teknik Elektro</option>
                    </select>
                    </div>
                </div> 
